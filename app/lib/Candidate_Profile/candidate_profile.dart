...
class candidate_ProfilePage extends StatelessWidget {
  final Candidates user;

  candidate_ProfilePage(this.user);
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            icon: Icon(
                Icons.logout_sharp), // Use Icon widget to represent the icon
          ),
        ],
      ),
              ...
              icon: InkWell(
                  onTap: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => Candidate_Home(user),
                        ));
                  },
