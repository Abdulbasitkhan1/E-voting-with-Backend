...
/*// Example usage
  ...
  Future<void> loginVoters(String cnic, String email, String password,BuildContext context) async {
    final response = await http.post(
  ...
  Future<void> loginAdmins(String cnic, String email, String password,BuildContext context) async {
    final response = await http.post(
  ...
  Future<void> loginCandidates(String cnic, String email, String password,BuildContext context) async {
  ...
  Future<void> updatePhoneNoVoter(String cnic, String newPhoneNo,BuildContext context) async {
    try {
  ...
  Future<void> updateEMailVoter(String cnic, String newEMail,BuildContext context) async {
    try {
      final response = await http.put(
  ...
  Future<void> updateLastNameVoter(String cnic, String newLastName,BuildContext context) async {
    try {
      final response = await http.put(
      ...
      if (response.statusCode == 200) {
        final Map<String, dynamic>? data = json.decode(response.body); // Use nullable type

        if (data != null) { // Check if data is not null
          final message = data['message']; // Access properties using null-aware operators
          final result = data['result'];
          print(message);
          print(result);
  ...
  Future<void> updateLastNameAdmin(String cnic, String newLastName,BuildContext context) async {
    try {
      final response = await http.put(
  ...
  Future<void> updatePhoneNoAdmin(String cnic, String newPhoneNo,BuildContext context) async {
    try {
      final response = await http.put(
  ...
  Future<void> updateEMailAdmin(String cnic, String newEMail,BuildContext context) async {
    try {
      final response = await http.put(
  ...
  Future<void> updateLastNameCandidate(String cnic, String newLastName,BuildContext context) async {
    try {
      final response = await http.put(
  ...
  Future<void> updatePhoneNoCandidate(String cnic, String newPhoneNo,BuildContext context) async {
    try {
      final response = await http.put(
  ...
  Future<void> updateEMailCandidate(String cnic, String newEMail,BuildContext context) async {
    try {
      final response = await http.put(
