  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomSheet: isLastPage
        ? TextButton(style: TextButton.styleFrom(primary: Colors.white, backgroundColor: Colors.blueAccent, minimumSize: Size.fromHeight(80)), child: Text('Get Started', style: TextStyle(fontSize: 24),),
      onPressed:() async {
